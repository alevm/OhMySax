...
3. Add workshop entries, before/after comparisons (with optional audio), or upload photos/audio
...
- Workshop log grouped by horn in two columns (one column per horn currently on the bench)
